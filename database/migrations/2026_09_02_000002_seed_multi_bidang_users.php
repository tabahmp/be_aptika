...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('users') || !Schema::hasTable('bidangs')) {
            return;
        }
    ...
    {
        $emails = [
            'admin@sekretariat.com', 'user1@sekretariat.com', 'user2@sekretariat.com',
            'admin@egov.com', 'user1@egov.com', 'user2@egov.com',
            'user2@aptika.com',
            'admin@ikp.com', 'user1@ikp.com', 'user2@ikp.com',
            'admin@persandian.com', 'user1@persandian.com', 'user2@persandian.com',
            'admin@statistik.com', 'user1@statistik.com', 'user2@statistik.com',
            'admin@plddig.com', 'user1@plddig.com', 'user2@plddig.com',
        ];
